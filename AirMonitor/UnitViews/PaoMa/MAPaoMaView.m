...
- (instancetype)initWithFrame:(CGRect)frame withTitle:(NSString *)title
{
    ...
    if (self) {
        ...
        myLable.text = title;
        myLable.font = [UIFont systemFontOfSize:font_size];
        myLable.textColor = [UIColor whiteColor];
        myLable.backgroundColor = [UIColor clearColor];
        
        //计算文本的宽度
        CGFloat calcuWidth = [self widthForTextString:title height:labelHeight fontSize:font_size];
        ...
        if (calcuWidth>frame.size.width) {
            ...
            behindLabel.font = [UIFont systemFontOfSize:font_size];
            behindLabel.backgroundColor = [UIColor clearColor];
            behindLabel.textColor = [UIColor whiteColor];
