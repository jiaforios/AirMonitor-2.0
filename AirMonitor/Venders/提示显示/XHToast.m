...
+(void)showFailContent:(NSString *)content hiddenTime:(CGFloat)time
{
    [self showBottomWithText:content bottomOffset:150 duration:2];
}
+(void)showSUCContent:(NSString *)content hiddenTime:(CGFloat)time
{
    [self showBottomWithText:content bottomOffset:150 duration:2];
}
+(void)showRemainContent:(NSString *)content hiddenTime:(CGFloat)time
{
    [self showBottomWithText:content bottomOffset:150 duration:2];
}
